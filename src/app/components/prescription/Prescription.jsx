...
function App() {
  const [dashboardId, setDashboardId] = useState('d8b59f8c-1e99-49c2-bcbf-609d256ba9a1');
...
if(atc2){
    let atc2String = '';    let atc2_1string = '';
    let atc2_2string = '';
    let atc2_3string = '';
    let atc2_4string = '';
    let atc2_5string = '';
...
<div className=''><h1 className='text-4xl font-extrabold '>Brand Analytic - Co Prescription Dashboard</h1></div>
