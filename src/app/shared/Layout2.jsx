...
const Layout2 = ({ children }) => {
  ...
  //   const timeUpdateInterval = setInterval(updateAccumulatedTime, 120000);
  ...
  //           },
  //           body: JSON.stringify({ timeSpent: newAccumulatedTime }),
  //         });
  ...
  //   const databaseSyncInterval = setInterval(syncWithDatabase, 6000);
  ...
  useEffect(() => {
    ...
    const databaseSyncInterval = setInterval(syncWithDatabase, 12000);
