...
function App() {
  ...
  const dashboard = process.env.NEXT_PUBLIC_DASHBOARD_ID4;

  useEffect(() => {
    const timeout = setTimeout(() => {
      fetch(
        `https://ar2qhujbfgipevxg67pxzajoei0rrivg.lambda-url.eu-central-1.on.aws/?dashboardId=${dashboardId}&atc2=${atc2String}`
        )
        ...
        <div className="flex flex-col md:flex-row gap-5 justify-between items-center my-5">
          <div className="">
            <h1 className="text-4xl font-extrabold ">
              Channel Analytic - Weighted Selling Distribution (Brand) Dashboard
            </h1>
          </div>
